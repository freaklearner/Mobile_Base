        ...
        Try
            If Not Session("rajat") Is Nothing Then
                If Not IsPostBack Then
                    ...
                    cmd.CommandText = "select LAST(ID) from SpecificationsTablet"
                    cmd.Connection = con
                    con.Open()
        ...
        If Page.IsValid Then
            ...
            Try
                If img4.Text.Length > 0 Then
                    ...
                    cmd.Parameters.AddWithValue("@brand", Integer.Parse(e.Values(4).ToString))
                    cmd.Parameters.AddWithValue("@model", e.Values(8).ToString)
