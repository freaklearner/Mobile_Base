<%@ Page Language="VB" AutoEventWireup="false" SmartNavigation="true" CodeFile="MobileView.aspx.vb" Inherits="MobileView" %>
	...
	<li class='active has-sub'>
		...
		<ul>
	        ...
	        <li class='has-sub'>
                ...
                <ul style="z-index:10; width:154px;">
			        <li class='has-sub'>
                                ...
                                <ItemTemplate>
                                    <div id="one">
                                        ...
                                        <center>
                                            ...
                                            <br />
                                            Model:
                                            <asp:Label runat="server" Text='<%# Eval("ModelId") %>' CssClass="labeltext"></asp:Label>
                                            <br />
                                            Price:
                                            <asp:Label runat="server" Text='<%# Eval("Price") %>' CssClass="labeltext"></asp:Label>
                                            <br />
                                            <asp:Button runat="server" CssClass="button" Text="Specifications" CommandName="B1"
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          SelectCommand="SELECT * FROM [Brand]"></asp:SqlDataSource>
			...
			<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
              ConnectionString="Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\MobileHub.accdb;Persist Security Info=True" 
              ProviderName="System.Data.OleDb" 
              SelectCommand="SELECT PriceCatogary.PriceID, PriceCatogary.PriceCatogary FROM (PriceCatogary INNER JOIN Specifications ON Specifications.PriceNo = PriceCatogary.PriceID) where s.brandno=?">
                    <SelectParameters>
			...
			<asp:SqlDataSource ID="SqlDataSource3" runat="server" 
              ...
              SelectCommand="SELECT s.ID, s.BrandNo, s.ModelID, s.Price, B.BrandName, I.img1,I.img2,I.img3,I.img4 FROM ((Specifications s INNER JOIN Images I ON s.ModelID = I.ModelId) INNER JOIN Brand B ON s.BrandNo = B.ID)">
          </asp:SqlDataSource>
			</font>    
			</font>    
