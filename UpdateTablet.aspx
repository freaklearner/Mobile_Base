<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateTablet.aspx.vb" Inherits="UpdateTablet" %>
...
<head runat="server">
	...
	<title>Admin|Update-Tablet</title>
    ...
    <form id="form1" runat="server">
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
         ...
         SelectCommand="SELECT * FROM [SpecificationsTablet] where [Id]=?" 
          ...
          UpdateCommand="UPDATE [SpecificationsTablet] SET [MemoryCard] = ?, [ExpandableStorage] = ?, [InternalStorage] = ?, [Ram] = ?, [Brand] = ?, 
          [InTheBox] = ?, [Sim] = ?, [SuportedNetwork] = ?, [ModelID] = ?, [VoiceCall] = ?, [Color] = ?, [Processor] = ?, [AudioFormatSupported] = ?, 
          [SecondaryCamera] = ?, [OtherCameraFeature] = ?, [PrimaryCamera] = ?, [Weigth] = ?, [Dimension] = ?, [4G] = ?, [PreInstalledBrowser] = ?, 
          [WiFi] = ?, [3G] = ?, [DisplayType] = ?, [OtherDisplayFeature] = ?, [WarrentySummery] = ?, [StandByTime] = ?, [BatteryType] = ?, [OtherConnectivityFeature] = ?,
          [AudioJack] = ?, [Bluetooth] = ?, [MapSupport] = ?, [GPS] = ?, [OS] = ?, [AdditionalFeatures] = ?, [Price] = ?, [PriceCatogary] = ? WHERE [ID] = ?" 
          DeleteCommand="DELETE FROM [SpecificationsTablet] WHERE [ID] = ?">
          <SelectParameters>
            <asp:ControlParameter PropertyName="SelectedValue" ControlID="DropDownList1" Name="ID" DbType="Int32" />
          </SelectParameters>
          <DeleteParameters>
         ...
         <UpdateParameters>
            ...
            <asp:Parameter Name="PriceCatogary" Type="Int32" />
            <asp:Parameter Name="ID" Type="Int32" />
         </UpdateParameters>
     </asp:SqlDataSource>
     <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
         ...
         SelectCommand="SELECT [ID], [ModelID] FROM [SpecificationsTablet] WHERE ([Brand] = ?) order by id">
         <SelectParameters>
             <asp:ControlParameter ControlID="drpListBrand" Name="Brand" 
		    ...
		    <asp:DetailsView runat="server" style="width:95%; height:auto;" 
                ...
                <Fields>                       
                    ...
                    <asp:TemplateField ItemStyle-CssClass="ItemStyle1" HeaderStyle-CssClass="HeaderStyle1" 
                        ...
                        <EditItemTemplate>
                            <asp:DropDownList runat="server" ID="drpPrice" DataSourceID="SqlDataSource4" DataTextField="PriceCatogary"
                    ...
                    <asp:CommandField ItemStyle-HorizontalAlign="Center" 
                        ButtonType="Button" ControlStyle-Width="200px" ShowEditButton="True" >
                    </asp:CommandField>
